    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrIfPathOrElsifPath;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrIfPathOrElsifPath() {
        if (notAnElementOrIfPathOrElsifPath == null) {
            notAnElementOrIfPathOrElsifPath = new ArrayList<JaxBSuperclass>();
        }
