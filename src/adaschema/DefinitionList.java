    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrDerivedTypeDefinitionOrDerivedRecordExtensionDefinition;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrDerivedTypeDefinitionOrDerivedRecordExtensionDefinition() {
        if (notAnElementOrDerivedTypeDefinitionOrDerivedRecordExtensionDefinition == null) {
            notAnElementOrDerivedTypeDefinitionOrDerivedRecordExtensionDefinition = new ArrayList<JaxBSuperclass>();
        }
