    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrOrdinaryTypeDeclarationOrTaskTypeDeclaration;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrOrdinaryTypeDeclarationOrTaskTypeDeclaration() {
        if (notAnElementOrOrdinaryTypeDeclarationOrTaskTypeDeclaration == null) {
            notAnElementOrOrdinaryTypeDeclarationOrTaskTypeDeclaration = new ArrayList<JaxBSuperclass>();
        }
