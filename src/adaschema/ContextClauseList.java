    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrUsePackageClauseOrUseTypeClause;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrUsePackageClauseOrUseTypeClause() {
        if (notAnElementOrUsePackageClauseOrUseTypeClause == null) {
            notAnElementOrUsePackageClauseOrUseTypeClause = new ArrayList<JaxBSuperclass>();
        }
