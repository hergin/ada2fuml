    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrNullStatementOrAssignmentStatement;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrNullStatementOrAssignmentStatement() {
        if (notAnElementOrNullStatementOrAssignmentStatement == null) {
            notAnElementOrNullStatementOrAssignmentStatement = new ArrayList<JaxBSuperclass>();
        }
