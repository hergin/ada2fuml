    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrDiscreteRangeAttributeReferenceOrDiscreteSimpleExpressionRange;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrDiscreteRangeAttributeReferenceOrDiscreteSimpleExpressionRange() {
        if (notAnElementOrDiscreteRangeAttributeReferenceOrDiscreteSimpleExpressionRange == null) {
            notAnElementOrDiscreteRangeAttributeReferenceOrDiscreteSimpleExpressionRange = new ArrayList<JaxBSuperclass>();
        }
