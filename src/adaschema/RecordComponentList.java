    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrComponentDeclarationOrNullComponent;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrComponentDeclarationOrNullComponent() {
        if (notAnElementOrComponentDeclarationOrNullComponent == null) {
            notAnElementOrComponentDeclarationOrNullComponent = new ArrayList<JaxBSuperclass>();
        }
