    ...
    extends JaxBSuperclass
{
    ...
    protected List<JaxBSuperclass> notAnElementOrExceptionHandlerOrAllCallsRemotePragma;
     ...
     * 
     */
    public List<JaxBSuperclass> getNotAnElementOrExceptionHandlerOrAllCallsRemotePragma() {
        if (notAnElementOrExceptionHandlerOrAllCallsRemotePragma == null) {
            notAnElementOrExceptionHandlerOrAllCallsRemotePragma = new ArrayList<JaxBSuperclass>();
        }
