...
class TemplateTest {
    ...
    void basicTemplateTest_Ada() {
        ...
        TemplateItem packageDeclName = new TemplateItem(new LHSAttribute("names_ql/defining_identifier", "def_name"), new RHSAttribute("name"));
        ...
        TemplateItem ordinaryTypeDeclName = new TemplateItem(new LHSAttribute("names_ql/defining_identifier", "def_name"), new RHSAttribute("name"));
        ...
        TemplateItem subTypeDeclName = new TemplateItem(new LHSAttribute("names_ql/defining_identifier", "def_name"), new RHSAttribute("name"));
        ...
        TemplateItem subTypeMarkName = new TemplateItem(new LHSAttribute("identifier", "ref_name"), new RHSAttribute("name"));
